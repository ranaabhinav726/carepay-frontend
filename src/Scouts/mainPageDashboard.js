...
const MainScout = () => {
    const [tabType, settabType] = useState('overview')
    let data = {
        "status": 200,
        "data": [
            {
    ...
    return (
        <>
            <div className="px-2 " style={{ position: 'sticky', top: '55px', width: '100%', background: '#fff', borderBottom: '5px solid #f2f2f2', paddingBottom: '10px' }}>
            ...
            <div style={{ marginTop: '20px' }}>
                {data && data.data && (data.data).map((carddata, i) => {
                    return (
