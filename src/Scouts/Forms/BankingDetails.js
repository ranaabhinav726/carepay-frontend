                    ...
                    <div className="detailsform">
                        ...
                        <div className="inputtags">
                            <div className="inputsgrps">
                                ...
                                <input autoComplete="off" type="number" name="accountNumber" value={Data.accountNumber} className='form-control input-tag' id='accountNumber' placeholder='Enter your Account Number' onChange={(e) => handlechange(e)} />
                            ...
                            <div className="inputsgrps">
                                ...
                                <input autoComplete="off" type="number" name="confirmaccountNumber" value={Data.confirmaccountNumber} className='form-control input-tag' id='confirmaccountNumber' placeholder='Confirm your Account Number' onChange={(e) => handlechange(e)} />
                            ...
                            <div className="inputsgrps">
                                ...
                                <input autoComplete="off" type="text" name="accountHolderName" value={Data.accountHolderName} className='form-control input-tag' id='accountHolderName' placeholder="Enter Account Holder's Name" onChange={(e) => handlechange(e)} />
                            ...
                            <div className="inputsgrps">
                                ...
                                <input autoComplete="off" type="text" name="IFSC" value={Data.IFSC} className='form-control input-tag' id='IFSC' placeholder='Enter IFSC Code' onChange={(e) => handlechange(e)} />
                            ...
                            <div className="inputsgrps">
                                ...
                                <input autoComplete="off" type="text" name="bankName" value={Data.bankName} className='form-control input-tag' id='bankName' placeholder='Enter Bank Name' onChange={(e) => handlechange(e)} />
                            ...
                            <div className="inputsgrps">
                                ...
                                <input autoComplete="off" type="text" name="branchName" value={Data.branchName} className='form-control input-tag' id='branchName' placeholder='Enter Branch Name' onChange={(e) => handlechange(e)} />
